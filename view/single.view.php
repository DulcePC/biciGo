    ...
    <div class="container">
        <div class="row">
            <div class="col l12 s12 m12">
                <div class="post">
                    <br>
                    <h3 class="titulo_single"><?php echo $post['titulo']; ?></h3>
                    <img src="<?php echo RUTA; ?>/fotos/<?php echo $post['thumb'];  ?>" class="imgpost z-depth-5">
                    <p class="fecha right"><?php echo fecha($post['fecha']); ?></p>
                </div>
            </div>
            <div class="col l12 m12 s12 descrip_post">
