<?php
    ...
    $articulos = $conexion->prepare("SELECT SQL_CALC_FOUND_ROWS * FROM accesorio ORDER BY id DESC LIMIT $inicio, $postPorPagina");
    $articulos->execute();
    ...
    <body>
        <div class="submenu">
            <div class="container">
                <ul class="col l12">
                    <li class="col s3">
                        <a class="modal-trigger" href="login.php">
                            <i class="material-icons tiny">lock_open</i>Entra</a>
                    </li>
                    <li class="col s3">
                        <a class="modal-trigger" href="registrate.php">
                            <i class="material-icons  tiny">lock_open</i>Registrate<a></li>
                            <li class="col s3">
                                <a>
                                    <i class="material-icons tiny">mail</i>bicigo@gmail.com</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <nav class="navprincipal">
                    <div class="nav-wrapper">
                        ...
                        <ul id="nav-mobile" class="right hide-on-med-and-down">
                            ...
                            <li>
                                <a class="btn btn-small green" href="usuario.php">Publicar</a>
                            </li>
                        </ul>
                    </div>
                </nav>
                <div class="container contenedor">
                            ...
                            <div class="card">
                                <div class="card-image">
                                    ...
                                    <a
                                        ...
                                        href="foto_accesorio.php?id=<?php echo $foto['id']; ?>">
                    ...
                    <div class="row">
                        <ul class="pagination right">
                            <?php if($pagina == 1): ?>
                            <!--esto es para deshabilitar el boton si tenemos una sola pagina-->
                            <li class='disabled'>
                                <a href="#ventas">
